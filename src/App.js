  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object({
        ...
        agree: Yup.bool().oneOf([true], 'Koşulları kabul etmelisiniz').required("kasullari kabul etmelisiniz"),})}
      ...
      {(formik) => (
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="checkbox topMargin">
              ...
              {formik.errors.agree && (
                <div style={{ color: 'red' }} className="input-feedback">{formik.errors.agree}</div>
              )}
